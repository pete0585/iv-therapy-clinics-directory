...
export default function ClaimIndexPage() {
  return (
    <div className="mx-auto max-w-lg px-4 py-20">
      <h1 className="text-2xl font-bold text-gray-900 mb-3">Claim Your IV Therapy Clinic Listing</h1>
      <p className="text-gray-500 mb-8">
        Search for your clinic below. Once you find your listing, click{" "}
